...
```{r}
t <- read.csv("M:/PhD/Year 4/Validation/ISH/PDGFRA_BAG3/ISH_BAG3_PDGFRa_df2.csv")
...
pdf(here("PhD","Thesis","thesisplots","20221015_BAG3_PDGFRa_barplots_colour.pdf"), width = 7, height = 9)
print(PlotList)
dev.off()
